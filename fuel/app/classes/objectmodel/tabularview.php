        ...
        if(!$this->executed) {
            ...
            foreach($this->record_objects as $record)
            {
                $edit_button = AdminHelpers::build_bootstrap_button($this->controller_path,
                    "edit/".$this->table_name."/".$record->id_field."/?return=".$this->return_path, "Edit");
            ...
            $this->add_button = AdminHelpers::build_bootstrap_button($this->controller_path, "edit/".$this->table_name."/0/?return=".$this->return_path, "Add new");
